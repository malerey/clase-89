...
const App = () => {
  ...
  // const saludo = "Madre, hija, hermana, guerrera"
  // const mostrarSaludo = true 
  // const saludoEspecialEstilado = true 

  // Evaluacion de cortocircuito
  // si esto es true, mostrar lo segundo {mostrarSaludo && saludo}

  // Operador tenario
  // Si esto es true,mostrar lo primero. Sino, mostrar lo segundo
  // mostrarSaludo ? saludo : "Hola"

  // const estiladoDelSaludo = saludoEspecialEstilado ? "dia-de-la-mujer" : "titulo-principal"


  
  return (
    // si la variable mostrarSaludo esta en true, quiero que en lugar de "Hola" mi pagina 
    // muestre el contenido de la variable saludo 

    // <h1>{mostrarSaludo && saludo}</h1>
    // <h1 className={`titulo-principal ${saludoEspecialEstilado && "dia-de-la-mujer"}`}>
    //   {mostrarSaludo ? saludo : "Hola"}
    // </h1>

    // Si la variable "saludo" existe, tiene contenido, mostramos saludo
    // Si no, mostramos "Hola". 

    // <h1>{saludo || "Hola"}</h1>
    // <h1>{saludo ? saludo : "Hola"}</h1>
    ...
    // los metodos de array son EXPRESIONES--> los puedo utilizar en JSX
    
    // <div>
    // {
    //   productos.map(producto => {
    //    if (producto.free_shipping) {
    //       return <Tarjeta title={producto.title} price={producto.price} free={producto.free_shipping}/>
    //    }
    //     })
    // }
    // </div>
